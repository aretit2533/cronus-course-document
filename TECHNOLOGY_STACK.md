...
graph TB
    ...
    subgraph Layer3["eqxjs-stub Foundation Layer"]
        C1["@eqxjs-commander<br/>Config & Commands"]
        C2["@eqxjs-decorator<br/>Metadata & Decorators"]
        C3["@eqxjs-transporter-http<br/>HTTP Transport"]
        C4["@eqxjs-logger<br/>Structured Logging"]
        C5["@eqxjs-pipes<br/>Transform & Validate"]
        C6["@eqxjs-utils<br/>Shared Utilities"]
        C7["@eqxjs-exception<br/>Error Handling"]
        C8["@eqxjs-security<br/>Auth & Security"]
    end
...
- **@eqxjs-commander**: Configuration management and command execution
- **@eqxjs-decorator**: Metadata management and custom decorators
- **@eqxjs-transporter-http**: HTTP client and transport layer
- **@eqxjs-logger**: Structured logging with multiple log levels
- **@eqxjs-pipes**: Data transformation and validation pipelines
- **@eqxjs-utils**: Shared utilities and helper functions
- **@eqxjs-exception**: Standardized error handling and exceptions
- **@eqxjs-security**: Authentication, authorization, and security features
